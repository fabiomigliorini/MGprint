...
let greeting = chalk.white.bold(
  "MGprint - Servidor de Impressao MG Papelaria!",
);
const boxenOptions = {
  padding: 1,
  margin: 0,
...
var ably = new Ably.Realtime(config.ably.key);
...
config.printers.forEach(function (printer) {
  ...
  let greeting = chalk.white.bold(
    "Escutando eventos da impressora '" + printer + "'!",
  );
